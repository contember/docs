...
If you go to [localhost:1480/articles](http://localhost:1480/article-list) you'll see list of your articles. Which is empty as we didn't add any data there yet.
...
```tsx title="admin/pages/articles.tsx"
import * as React from 'react'
import { CreatePage, DataGridPage, TextAreaField, TextCell, TextField } from '@contember/admin'
...
2. This time we'll use `CreatePage` component exported as `articleCreate`
...
Now at [localhost:1480/article-new](http://localhost:1480/article-create) you can create new article. And if you go to the [list of articles](http://localhost:1480/article-list) you'll see the data are there.
...
```tsx title="admin/pages/articles.tsx"
import * as React from 'react'
import { CreatePage, DataGridPage, EditPage, TextAreaField, TextCell, TextField } from '@contember/admin'
