...
#### 3. Add a new block to Interface
...
Now you can check your new section in <a href="http://localhost:1480" target="_blank">Interface</a> and try adding this new block to a page.
