...
Internally, Contember uses `_*-above_` schema variants to make compoents stand out (lighter) and `_*-below_` schema variants to push them a litthe to the back (darker). We don't endorse nor discourage you to use these in your layouts.
...
`theme` | `Intent` | Sets the theme of all layout parts for both content and control components
`themeContent` | `Intent` | Sets the theme of all layout parts for content independently
`themeControls` | `Intent` | Sets the theme of all layout parts for control components independently
`pageTheme` | `Intent` | Sets the page theme of both the content and the control components of the page part of the layout
`pageThemeContent` | `Intent` | Sets the page theme of the content of the page part of the layout independently
`pageThemeControls` | `Intent` | Sets the page theme of the control components of the page part of the layout independently
`titleTheme` | `Intent` | Sets the theme for both content and control components of the page title
`titleThemeContent` | `Intent` | Sets the theme of the content of the page title independently
`titleThemeControls` | `Intent` | Sets the theme of the control components of the page title independently
