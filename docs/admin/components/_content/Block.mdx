...
<Tabs
  defaultValue="block-editor"
  values={[
    { label: "Used in BlockEditor", value: "block-editor" },
    { label: "Used in BlockRepeater", value: "block-repeater" },
    { label: "Schema", value: "schema" },
  ]}
>

  <TabItem value="block-editor">
    <LiveCode
      entity="BlockEditor"
      code={
`<BlockEditor 
