...
The `GenericPage` doesn't contain [`DataBidingProvider`](/admin/components/data-binding#data-binding-provider). If you want to work with entites inside `GenericPage` component you will have to add it.
