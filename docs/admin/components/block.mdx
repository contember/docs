...
The `Block` component is used for wrapping fields in [`BlockRepeater`](/admin/components/content#block-repeater), [`BlockEditor`](/admin/components/content#block-editor) or [`DiscriminatedBlocks`](/admin/components/discrimination#discriminated-blocks) components.
