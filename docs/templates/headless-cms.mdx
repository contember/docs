...
Now you are ready to start working. You can change our template as you want to. Below, you can find some examples of possible customization.
...
### Editing testimonials from one place
